...
const specialGreeting = greeting.bind(company, company.firstName, company.lastName);
...
const getUkrainePopulation = getPopulation.bind(country, country.population);
